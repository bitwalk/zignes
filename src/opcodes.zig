...
pub const cpu_ops_codes = [_]OpCode{
    ...
    OpCode.init(0x75, "ADC", 2, 4, .ZeroPage_X),
    OpCode.init(0x6d, "ADC", 3, 4, .Absolute),
    OpCode.init(0x7d, "ADC", 3, 4, .Absolute_X), // +1 if page crossed
    OpCode.init(0x79, "ADC", 3, 4, .Absolute_Y), // +1 if page crossed
    OpCode.init(0x61, "ADC", 2, 6, .Indirect_X),
    OpCode.init(0x71, "ADC", 2, 5, .Indirect_Y), // +1 if page crossed

    OpCode.init(0xe9, "SBC", 2, 2, .Immediate),
    OpCode.init(0xe5, "SBC", 2, 3, .ZeroPage),
    OpCode.init(0xf5, "SBC", 2, 4, .ZeroPage_X),
    OpCode.init(0xed, "SBC", 3, 4, .Absolute),
    OpCode.init(0xfd, "SBC", 3, 4, .Absolute_X), // +1 if page crossed
    OpCode.init(0xf9, "SBC", 3, 4, .Absolute_Y), // +1 if page crossed
    OpCode.init(0xe1, "SBC", 2, 6, .Indirect_X),
    OpCode.init(0xf1, "SBC", 2, 5, .Indirect_Y), // +1 if page crossed

    OpCode.init(0x29, "AND", 2, 2, .Immediate),
    OpCode.init(0x25, "AND", 2, 3, .ZeroPage),
    OpCode.init(0x35, "AND", 2, 4, .ZeroPage_X),
    OpCode.init(0x2d, "AND", 3, 4, .Absolute),
    OpCode.init(0x3d, "AND", 3, 4, .Absolute_X), // +1 if page crossed
    OpCode.init(0x39, "AND", 3, 4, .Absolute_Y), // +1 if page crossed
    OpCode.init(0x21, "AND", 2, 6, .Indirect_X),
    OpCode.init(0x31, "AND", 2, 5, .Indirect_Y), // +1 if page crossed

    OpCode.init(0x49, "EOR", 2, 2, .Immediate),
    OpCode.init(0x45, "EOR", 2, 3, .ZeroPage),
    OpCode.init(0x55, "EOR", 2, 4, .ZeroPage_X),
    OpCode.init(0x4d, "EOR", 3, 4, .Absolute),
    OpCode.init(0x5d, "EOR", 3, 4, .Absolute_X), // +1 if page crossed
    OpCode.init(0x59, "EOR", 3, 4, .Absolute_Y), // +1 if page crossed
    OpCode.init(0x41, "EOR", 2, 6, .Indirect_X),
    OpCode.init(0x51, "EOR", 2, 5, .Indirect_Y), // +1 if page crossed

    OpCode.init(0x09, "ORA", 2, 2, .Immediate),
    OpCode.init(0x05, "ORA", 2, 3, .ZeroPage),
    OpCode.init(0x15, "ORA", 2, 4, .ZeroPage_X),
    OpCode.init(0x0d, "ORA", 3, 4, .Absolute),
    OpCode.init(0x1d, "ORA", 3, 4, .Absolute_X), // +1 if page crossed
    OpCode.init(0x19, "ORA", 3, 4, .Absolute_Y), // +1 if page crossed
    OpCode.init(0x01, "ORA", 2, 6, .Indirect_X),
    OpCode.init(0x11, "ORA", 2, 5, .Indirect_Y), // +1 if page crossed

    // Shifts
    OpCode.init(0x0a, "ASL", 1, 2, .NoneAddressing),
    OpCode.init(0x06, "ASL", 2, 5, .ZeroPage),
    OpCode.init(0x16, "ASL", 2, 6, .ZeroPage_X),
    OpCode.init(0x0e, "ASL", 3, 6, .Absolute),
    OpCode.init(0x1e, "ASL", 3, 7, .Absolute_X),

    OpCode.init(0x4a, "LSR", 1, 2, .NoneAddressing),
    OpCode.init(0x46, "LSR", 2, 5, .ZeroPage),
    OpCode.init(0x56, "LSR", 2, 6, .ZeroPage_X),
    OpCode.init(0x4e, "LSR", 3, 6, .Absolute),
    OpCode.init(0x5e, "LSR", 3, 7, .Absolute_X),

    OpCode.init(0x2a, "ROL", 1, 2, .NoneAddressing),
    OpCode.init(0x26, "ROL", 2, 5, .ZeroPage),
    OpCode.init(0x36, "ROL", 2, 6, .ZeroPage_X),
    OpCode.init(0x2e, "ROL", 3, 6, .Absolute),
    OpCode.init(0x3e, "ROL", 3, 7, .Absolute_X),

    OpCode.init(0x6a, "ROR", 1, 2, .NoneAddressing),
    OpCode.init(0x66, "ROR", 2, 5, .ZeroPage),
    OpCode.init(0x76, "ROR", 2, 6, .ZeroPage_X),
    OpCode.init(0x6e, "ROR", 3, 6, .Absolute),
    OpCode.init(0x7e, "ROR", 3, 7, .Absolute_X),

    OpCode.init(0xe6, "INC", 2, 5, .ZeroPage),
    OpCode.init(0xf6, "INC", 2, 6, .ZeroPage_X),
    OpCode.init(0xee, "INC", 3, 6, .Absolute),
    OpCode.init(0xfe, "INC", 3, 7, .Absolute_X),

    OpCode.init(0xe8, "INX", 1, 2, .NoneAddressing),
    OpCode.init(0xc8, "INY", 1, 2, .NoneAddressing),

    OpCode.init(0xe7, "DEC", 2, 5, .ZeroPage),
    OpCode.init(0xf7, "DEC", 2, 6, .ZeroPage_X),
    OpCode.init(0xce, "DEC", 3, 6, .Absolute),
    OpCode.init(0xde, "DEC", 3, 7, .Absolute_X),
    ...
    OpCode.init(0xd5, "CMP", 2, 4, .ZeroPage_X),
    OpCode.init(0xcd, "CMP", 3, 4, .Absolute),
    OpCode.init(0xdd, "CMP", 3, 4, .Absolute_X), // +1 if page crossed
    OpCode.init(0xd9, "CMP", 3, 4, .Absolute_Y), // +1 if page crossed
    OpCode.init(0xc1, "CMP", 2, 6, .Indirect_X),
    OpCode.init(0xd1, "CMP", 2, 5, .Indirect_Y), // +1 if page crossed
    ...
    OpCode.init(0xbd, "LDA", 3, 4, .Absolute_X), // +1 if page crossed
    OpCode.init(0xb9, "LDA", 3, 4, .Absolute_Y), // +1 if page crossed
    OpCode.init(0xa1, "LDA", 2, 6, .Indirect_X),
    OpCode.init(0xb1, "LDA", 2, 5, .Indirect_Y), // +1 if page crossed

    OpCode.init(0xa2, "LDX", 2, 2, .Immediate),
    OpCode.init(0xa6, "LDX", 2, 3, .ZeroPage),
    OpCode.init(0xb6, "LDX", 2, 4, .ZeroPage_Y),
    OpCode.init(0xae, "LDX", 3, 4, .Absolute),
    OpCode.init(0xbe, "LDX", 3, 4, .Absolute_Y), // +1 if page crossed

    OpCode.init(0xa0, "LDY", 2, 2, .Immediate),
    OpCode.init(0xa4, "LDY", 2, 3, .ZeroPage),
    OpCode.init(0xb4, "LDY", 2, 4, .ZeroPage_X),
    OpCode.init(0xac, "LDY", 3, 4, .Absolute),
    OpCode.init(0xbc, "LDY", 3, 4, .Absolute_X), // +1 if page crossed
    ...
    OpCode.init(0x96, "STX", 2, 4, .ZeroPage_Y),
    OpCode.init(0x8e, "STX", 3, 4, .Absolute),

    OpCode.init(0x84, "STY", 2, 3, .ZeroPage),
    OpCode.init(0x94, "STY", 2, 4, .ZeroPage_X),
